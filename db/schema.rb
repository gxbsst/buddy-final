...
ActiveRecord::Schema.define(:version => 20121018031919) do
  ...
  create_table "refinery_participates", :force => true do |t|
    t.string   "title"
    t.integer  "photo_id"
    t.string   "photo_url"
    t.integer  "position"
  ...
  create_table "refinery_pictures", :force => true do |t|
    t.string   "title"
    t.string   "url"
    t.integer  "photo_id"
    t.integer  "position"
  ...
  create_table "refinery_shares", :force => true do |t|
    t.string   "title"
    t.string   "people_name"
    t.date     "time"
    t.text     "content"
