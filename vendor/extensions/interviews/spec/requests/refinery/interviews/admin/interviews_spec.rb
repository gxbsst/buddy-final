      ...
      describe "interviews" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:interview, :people_name => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:interview, :people_name => "A people_name") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:interview, :people_name => "UniqueTitleOne") }
